        ...
        slimScroll: function(options) {
            ...
            this.each(function() {
                ...
                me.on('touchmove', function(e) {
                    if (!releaseScroll) {
                        e.preventDefault();  // ถ้าต้องการป้องกัน scroll ให้ใช้ passive: false
                    }
                    if (e.originalEvent.touches.length) {
                ...
                }, { passive: true });  // เพิ่ม passive: true ที่นี่
                
                // เพิ่ม passive: true ให้กับ mousewheel event
                function _onWheel(e) {
                    if (!isOverPanel) {
                        return;
                    }
                ...
                // การใช้ passive: true สำหรับ mousewheel event
