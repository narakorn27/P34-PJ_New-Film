!function(t, e) {
          ...
          , l = function(t) {
            ...
            e.prototype.bindDateHandlerToEl = function(t, e, n) {
                ...
                this.el.on(e, function(t) {
                    if (!i(t.target).is(r.segSelector + "," + r.segSelector + " *,.fc-more,a[data-goto]"))
                        return n.call(r, t)
                })
            }
            ,
        ...
        var r = n(0)
          ...
          , p = function(t) {
            ...
            e.prototype.startNowIndicator = function() {
                ...
                n = this.initialNowDate.clone().startOf(t).add(1, t) - this.initialNowDate,
        ...
        var r = n(1)
          ...
          , o = function() {
            ...
            t.prototype.queryBoundingRect = function() {
                ...
                !t.is(document)) ? i.getClientRect(t) : null
            }
            ,
        ...
        var r = n(0)
          ...
          , s = function(t) {
            ...
            e.prototype.renderHeadDateCellHtml = function(t, e, n) {
                ...
                return 1 === r.rowCnt ? a = a.concat(r.getDayClasses(t, !0)) : a.push("fc-" + i.dayIDs[t.day()]),
                '<th class="' + a.join(" ") + '"' + (1 === (s && r.rowCnt) ? ' data-date="' + t.format("YYYY-MM-DD") + '"' : "") + (e > 1 ? ' colspan="' + e + '"' : "") + (n ? " " + n : "") + ">" + (s ? o.buildGotoAnchorHtml({
                    date: t,
          ...
          , I = function() {
            ...
            t.prototype.initialRender = function() {
                ...
                this.optionsManager.watch("settingBusinessHourGenerator", ["?businessHours"], function(e) {
                    t.businessHourGenerator = new D.default(e.businessHours,t),
            ...
            t.prototype.initToolbars = function() {
                ...
                this.toolbarsManager = new a.default([this.header, this.footer])
            }
            ,
            ...
            t.prototype.moment = function() {
                for (var t = [], e = 0; e < arguments.length; e++)
                    t[e] = arguments[e];
                var n;
                return "local" === this.opt("timezone") ? (n = v.default.apply(null, t),
                n.hasTime() && n.local()) : n = "UTC" === this.opt("timezone") ? v.default.utc.apply(null, t) : v.default.parseZone.apply(null, t),
    ...
    , function(t, e, n) {
        ...
        var r = n(0)
          ...
          , u = function(t) {
            ...
            return r.__extends(e, t),
            e.prototype.buildRenderRange = function(e, n, r) {
                var i, o = t.prototype.buildRenderRange.call(this, e, n, r), a = this.msToUtcMoment(o.startMs, r), l = this.msToUtcMoment(o.endMs, r);
        ...
        e.default = d,
        d.prototype.dateProfileGeneratorClass = u
    }
    , function(t, e, n) {
        Object.defineProperty(e, "__esModule", {
            value: !0
    ...
    , function(t, e, n) {
        ...
        r.fn.fullCalendar = function(t) {
            ...
            return this.each(function(i, o) {
                ...
                i || (n = l),
                "destroy" === t && u.removeData("fullCalendar")) : s.warn("'" + t + "' is an unknown FullCalendar method.") : s.warn("Attempting to call a FullCalendar method on an element with no calendar.") : d || (d = new a.default(u,t),
    ...
    , function(t, e, n) {
        ...
        var a = n(20);
        e.datepickerLocale = a.datepickerLocale,
        e.locale = a.locale;
        var l = n(9);
        e.moment = l.default;
        var u = n(8);
            ...
            t.prototype.renderSection = function(t) {
                ...
                return u && r.each(u.split(" "), function(t, s) {
                    ...
                    r.each(s.split(","), function(t, s) {
                        ...
                        y ? m = i.htmlEscape(y) : v && (m = "<span class='" + v + "'></span>"),
                        w = r('<button type="button" class="' + b.join(" ") + '">' + m + "</button>").click(function(t) {
